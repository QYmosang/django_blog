"""
Django settings-backup for myblog project.
...
For the full list of settings-backup and their values, see
...
SECRET_KEY = '8b%fj&ir=4zth0=9nr+knqi!r&5jy7t*&g-f%muyxvb7jqshun'
